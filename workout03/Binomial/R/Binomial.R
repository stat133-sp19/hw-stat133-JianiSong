...
#' @export
#' @examples check the following cases.
# bin_choose(n = 5, k = 2)
# bin_choose(5,0)
# bin_choose(5,1:3)
#' @export
...
plot.bindist <- function(x){
  library(ggplot2)
  bin_dis <- ggplot2::ggplot(x, ggplot2::aes(x= x$success, y = x$probability))+ labs(x="successes")+ ggplot2::geom_histogram(stat = "identity", color = "#C0C0C0", fill="#C0C0C0")+ ggplot2::theme_classic()
...
plot.bincum <- function(x){
  library(ggplot2)
  bincum <- ggplot2::ggplot(data = x, ggplot2::aes(x= success, y = cumulative)) + ggplot2::geom_line() + ggplot2::geom_point(shape = 1, size = 3) + ggplot2::theme_classic() + ggplot2::labs(x = "success", y = "")
